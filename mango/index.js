...
const initializeDefaultRecords = async () => {
    try {
        // Delete all existing documents in the fruits collection
        ...
        if (count === 0) {
            ...
            await Fruit.insertMany([
                ...
                { id: 'd07c3907ea5e559981518e21', name: 'flag{tutti_frutti}', price: 999.99 }
            ]);
...
// // Populate MongoDB with default and flag records
// const flagRecord = new Record({ name: 'flag', data: 'flag{}' });

// db.once('open', async () => {
//   try {
//     await Record.deleteMany(); // Clear existing records
//     await Record.insertMany([defaultRecord, flagRecord]);
//     console.log('MongoDB seeded with initial records.');
//   } catch (err) {
